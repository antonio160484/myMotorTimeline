        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IntervaloMeses = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TiposMantenimientos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KilometrajeActual = table.Column<int>(type: "int", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KilometrajeObjetivo = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MantenimientosProgramados_TiposMantenimientos_TipoMantenimientoId",
                        column: x => x.TipoMantenimientoId,
                        principalTable: "TiposMantenimientos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MantenimientosProgramados_Vehiculos_VehiculoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MantenimientosRealizados_TiposMantenimientos_TipoMantenimientoId",
                        column: x => x.TipoMantenimientoId,
                        principalTable: "TiposMantenimientos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MantenimientosRealizados_Vehiculos_VehiculoId",
                        column: x => x.VehiculoId,
                        principalTable: "Vehiculos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MantenimientosProgramados_TipoMantenimientoId",
                table: "MantenimientosProgramados",
                column: "TipoMantenimientoId");

            migrationBuilder.CreateIndex(
                name: "IX_MantenimientosProgramados_VehiculoId",
                table: "MantenimientosProgramados",
                column: "VehiculoId");

            migrationBuilder.CreateIndex(
                name: "IX_MantenimientosRealizados_TipoMantenimientoId",
                table: "MantenimientosRealizados",
                column: "TipoMantenimientoId");

            migrationBuilder.CreateIndex(
                name: "IX_MantenimientosRealizados_VehiculoId",
                table: "MantenimientosRealizados",
                column: "VehiculoId");
